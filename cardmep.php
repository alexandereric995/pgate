...
<form id="mdecEnginePay" action="" method="post">
    <div class="field-row">
...
<select name="year" id="year"
    ...
    <div>
        <input type="submit" name="pay_now" value="Submit"
            ...
            onClick="mdecEnginePay(event);">
        <div id="loader">
            <img alt="loader" src="Eclipse.svg">
        </div>
    </div>
    <input type='hidden' name='amount' value=''> <input type='hidden'
        name='currency_code' value='MYR'> <input type='hidden'
        name='item_name' value='product_id'> <input type='hidden'
        name='item_number' value='PHPimep'>
</form>
